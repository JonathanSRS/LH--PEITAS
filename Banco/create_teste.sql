...
cd_imagem NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY
, cd_camisa NUMERIC
...
SELECT * FROM T_LHP_TIME WHERE nm_time LIKE '%gremio%';
...
WHERE t.nm_time LIKE '%al%'; 

--TRIGGER 
-- DELETAR TIME E CAMISA
-- DELETAR CAMISA E IMAGEM